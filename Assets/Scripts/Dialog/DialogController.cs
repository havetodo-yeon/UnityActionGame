...
// 일반 팝업 창과 확인 팝업 창을 관리하는 DialogControllerAlert, DialogCntrollerConfirm의 부모 클래스
public class DialogController : MonoBehaviour
{
    ...
    public bool Visible
    {
        get
        {
            ...
            // 해당 오브젝트가 활성화되어있는 지 아닌 지를 판단하는 읽기 전용 값 activeSelf
        }
        ...
        private set
        {
            ...
            // private 처리하여 외부에서 간섭할 수 없습니다.
        }
    }

    // 가상함수 : 자식 쪽에서 오버라이딩 할 것이 예상될 경우 작성하는 키워드
